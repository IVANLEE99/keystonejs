...
exports = module.exports = function (app) {
	...
	//删除博客
	app.get('/myblog/remove/:id', routes.views.myblog_remove);
	//修改博客页面
	app.get('/myblog/modify/:id', routes.views.myblog_modify_page);

	//修改博客
	app.post('/myblog_modify', routes.views.myblog_modify);
